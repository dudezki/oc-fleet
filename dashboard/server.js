...
const PROVIDER_MODEL_MAP = {
  ...
  google:     { prefix: 'google/',    models: ['gemini-2.0-flash', 'gemini-2.0-pro', 'gemini-1.5-pro', 'gemini-1.5-flash'] },
  gemini:     { prefix: 'google/',    models: ['gemini-2.0-flash', 'gemini-2.0-pro', 'gemini-1.5-pro', 'gemini-1.5-flash'] },
...
function buildAuthProfile(provider, apiKey, baseUrl) {
  switch (provider) {
    ...
    case 'google':
    case 'gemini':
      return { type: 'token', provider: 'google', token: apiKey };
    case 'ollama':
